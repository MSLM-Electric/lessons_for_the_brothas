//!!!! THIS FILE IS NOT MINE. SPECIAL THANKS TO CONTRIBUTORS OF Autosar based ADAS application Project (AUTOSAR-COM-STACK). !!!//
//!!!! original workings located on https://github.com/Ziad-abdelkarim/AUTOSAR-COM-STACK
